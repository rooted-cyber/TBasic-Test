...
wrong2 () {
	...
	wrong4 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong4
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	#rm -f wrong4 > /dev/null 2>&1
	rm -f wrong5 > /dev/null 2>&1
	...
	wrong5 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong5
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	#rm -f wrong5 > /dev/null 2>&1
	...
	wrong6 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong6
	cd /sdcard
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	...
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	cd /sdcard
	echo "wrong" >> ~/TBasic-Test/Results/wrong7
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	rm -f wrong5 > /dev/null 2>&1
	...
	wrong8 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong8
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	rm -f wrong5 > /dev/null 2>&1
	...
	wrong9 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong9
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	rm -f wrong5 > /dev/null 2>&1
	...
	wrong10 () {
	printf "\n\n \033[91m [×] Your answer is wrong.\n\n"
	echo "wrong" >> ~/TBasic-Test/Results/wrong10
	rm -f wrong2 > /dev/null 2>&1
	rm -f wrong3 > /dev/null 2>&1
	rm -f wrong4 > /dev/null 2>&1
	rm -f wrong5 > /dev/null 2>&1
